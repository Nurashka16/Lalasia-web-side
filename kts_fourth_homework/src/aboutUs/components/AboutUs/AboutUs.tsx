...
const AboutUs = () => {
  return (
    <div className={style.aboutUs}>
      <div className={style.aboutUs_frame__top}></div>
      <div className={style.main}>
        ...
        <div className={style.main_content}>
          ...
          >
            &ensp; Lalasia is online store that provides its customers with more
            than 100 million product items in 20 categories, including:
            ...
            <br />
            <br />
            &ensp; It ranks sixth in the list of the most valuable companies on
            the Russian Internet according to the Russian Forbes (in February
            2016, the magazine estimated the company’s value at $680 million).
          </Text>
          <img
